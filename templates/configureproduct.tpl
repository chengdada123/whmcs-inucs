...
{* 生成一个 100000 到 999999 之间的随机6位数，并赋值给 randomId 变量 *}
{assign var="randomId" value=mt_rand(100000, 999999)}                                            
<input type="hidden" name="hostname" class="form-control" id="inputHostname" value="{$randomId}.loca" placeholder="servername.example.com">
<input type="hidden" name="ns1prefix" class="form-control" id="inputNs1prefix" value="ns1" placeholder="ns1">  
<input type="hidden" name="ns2prefix" class="form-control" id="inputNs2prefix" value="ns2" placeholder="ns2">                                             
